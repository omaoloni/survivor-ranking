...
def main(episode_no, working_directory) -> None:
    """ 
    ...
    prev_episode_player_scores = get_player_scores(episode_no - 1, working_directory)
    ...
    # prev_episode_player_scores = [ ('olivia', 10), ('robert', 5), ('buffy', 20) ]
    # curr_episode_player_scores = [ ('olivia', 30), ('robert', 25), ('buffy', 22) ]

    prev_round_rankings = get_ranking(prev_episode_player_scores)

    curr_round_power_rankings = get_power_ranking(prev_round_rankings, curr_episode_player_scores)
